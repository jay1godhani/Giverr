    ...
    <div className="container">
      ...
      <div className="sections">
        <div className="left">
          ...
          <textarea name="desc" id="" cols="30" rows="16" placeholder="Brief descriptions to introduce your service to cutomer" onChange={handleChange}></textarea>
        ...
        <div className="right">
          ...
          <textarea name="shortDesc" id="" cols="30" rows="10" placeholder="Short descriptions to introduce your service to cutomer" onChange={handleChange}></textarea>
